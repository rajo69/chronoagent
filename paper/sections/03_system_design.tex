...
protocol~\citep{contractnet}; each agent bids a cost that is a
function of its own health score and queue depth. The allocator picks
the lowest-cost bid. A drifting agent's health score drops, its cost
rises, and work routes away from it automatically, without a
